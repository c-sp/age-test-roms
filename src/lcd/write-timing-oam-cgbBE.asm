...
;    fails on DMG-CPU C (blob) - DMG-CPU-08 (2021-07-09)
;
; Verified (DMG_C set):
;    fails on CPU CGB E - CPU-CGB-06 (2021-07-09)
;    fails on CPU CGB B - CPU-CGB-02 (2021-07-09)
;   passes on DMG-CPU C (blob) - DMG-CPU-08 (2021-07-09)
;
IF DEF(DMG_C)
