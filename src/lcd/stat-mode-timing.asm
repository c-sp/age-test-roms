...
EXPECTED_SCANLINE_STATS:
    ...
    DB $80, $80, $80, $80,  $80, $80, $81, $81,  $81, $80, $80, $80 ; fails on CGB-E (9)
...
DEF M0_INITIAL_NOPS  EQU ((80 + 172) / 4 - 12)
DEF M12_INITIAL_NOPS EQU (456 / 4 - 13)
DEF M3_INITIAL_NOPS  EQU (80 / 4 - 12)
...
run_test:
    ...
    FOR SCX, 10
        READ_LINES_STAT SCX, M0_INITIAL_NOPS
        READ_LINES_STAT SCX, M0_INITIAL_NOPS + 1
        READ_LINES_STAT SCX, M0_INITIAL_NOPS + 2
    ENDR

    READ_LINES_STAT 0, M12_INITIAL_NOPS
    READ_LINES_STAT 0, M12_INITIAL_NOPS + 1
    READ_LINES_STAT 0, M12_INITIAL_NOPS + 2
    READ_LINES_STAT 7, M12_INITIAL_NOPS
    READ_LINES_STAT 7, M12_INITIAL_NOPS + 1
    READ_LINES_STAT 7, M12_INITIAL_NOPS + 2

    READ_LINES_STAT 0, M3_INITIAL_NOPS
    READ_LINES_STAT 0, M3_INITIAL_NOPS + 1
    READ_LINES_STAT 7, M3_INITIAL_NOPS
    READ_LINES_STAT 7, M3_INITIAL_NOPS + 1
